...
#define STRING_CONFIG_H_AUTHOR "(KovtunAS, Print-O-Matic)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Print-O-Matic"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "8b417225-0eca-4a0e-82f2-87384fe7856b"
...
#define PID_MAX  255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Point-O-Matic (AntiNeXus) version
  #define  DEFAULT_Kp 23.79
  #define  DEFAULT_Ki 1.72
  #define  DEFAULT_Kd 82.45
...
#define DELTA
  ...
  #define DELTA_EFFECTOR_OFFSET 26.5 // mm
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 94.96} //94.96 is NOT a real value I think
...
//#define DEFAULT_EJERK                 20.0    // (mm/sec) -- antinexus
...
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -9.2  // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
...
#define Z_PROBE_SPEED_FAST 4000 //it was originally HOMING_FEEDRATE_Z
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define DELTA_PROBEABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 25) //35
  #define LEFT_PROBE_BED_POSITION -(DELTA_PRINTABLE_RADIUS + X_PROBE_OFFSET_FROM_EXTRUDER)
  #define RIGHT_PROBE_BED_POSITION (DELTA_PRINTABLE_RADIUS)
  #define FRONT_PROBE_BED_POSITION -(DELTA_PRINTABLE_RADIUS + Y_PROBE_OFFSET_FROM_EXTRUDER)
...
//antinexus's value
//#define MANUAL_Z_HOME_POS 265.1 // Distance between the nozzle to printbed after homing
//melipharo's value
//#define MANUAL_Z_HOME_POS 266
//melipharo's new value for autolevel testing
#define MANUAL_Z_HOME_POS 268
